...
export async function getFarcasterManifest() {
  ...
  return {
    ...
    miniapp: {
      ...
      subtitle: "Anti spam message system ", // 30 characters, no emojis or special characters, short description under app name
      description: "Anti spam message system ", // 170 characters, no emojis or special characters, promotional message displayed on Mini App Page
      ...
      ogDescription: "Anti spam message system ", // 100 characters, summarize core benefits in 1-2 lines
      screenshotUrls: [
